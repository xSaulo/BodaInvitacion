...
const SuitIcon = ({ className }) => (
  <svg 
    className={className} 
    viewBox="0 0 512 512" 
    fill="currentColor" /* Esto hace que use el color de la clase de Tailwind */
...
const DressCode = () => {
  return (
    <div className="text-center p-6 flex flex-col items-center">
      <div className="mb-4">
        {/* Aquí aplicamos el color terracota directamente al componente SVG */}
        <SuitIcon className="w-16 h-16 text-boda-terracota" />
      </div>
